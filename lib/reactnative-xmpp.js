...
Client.prototype.join = function (room, nick, history, cb) {
  ...
  return this.write('<presence from="'+ this.jid +'" to="'+ room + '/' + nick + '"><x xmlns="http://jabber.org/protocol/muc"><history maxchars="0"/></x><x xmlns="http://jabber.org/protocol/muc#user"><item affiliation="member" role="participant" /></x></presence>');
};
