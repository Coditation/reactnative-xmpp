...
Client.prototype.queue_command = function (command_type, command, commandId) {
  if (!command instanceof Command) {
    throw "This command is not supported";
  }

  this.command_queue.queue_element({command_type, command, commandId})
...
Client.prototype.push = function (to, str, type, data=undefined, is_retry=false, recipients=undefined) {
  ...
  this.queue_command(COMMAND_TYPES.STREAM_SEND_MESSAGE, send_message_command, data.newId)
...
Client.prototype.resetTimeouts = function (argument) {
