...
AsyncStorageBackedQueue.prototype.read_queue = function() {
...
AsyncStorageBackedQueue.prototype.read_queue_plain = function() {
...
AsyncStorageBackedQueue.prototype.read_queue_decrypted = function() {
   AsyncStorage.getItem(this.queue_name).then((data) => {
    if(data) {
...
AsyncStorageBackedQueue.prototype._persist_queue_plain = function() {
...
AsyncStorageBackedQueue.prototype._persist_queue_encrypted = function() {
